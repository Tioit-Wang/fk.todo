...
const STRINGS: Record<AppLanguage, Record<string, string>> = {
  zh: {
    ...
    "forced.action.snoozeMore": "其他时间",
    "forced.action.snoozeLess": "收起",
    ...
    "settings.about.button": "查看",
    "settings.about.description":
      "开发者 TioitWang\n此软件完全由 Openai Codex 开发",
    ...
    "settings.theme.elegant": "淡雅（白+浅蓝）",
    "settings.theme.web90s": "90年代网页风",
    "settings.theme.tech": "科技风",
    "settings.theme.calm": "沉稳",
    "settings.theme.cyberpunk": "赛博朋克",
    "settings.uiRadius": "圆角",
    "settings.uiRadius.theme": "跟随主题",
    "settings.uiRadius.sharp": "锐利",
    "settings.uiRadius.round": "圆润",
    "settings.uiBorder": "边框粗细",
    "settings.uiBorder.theme": "跟随主题",
    "settings.uiBorder.thin": "细",
    "settings.uiBorder.thick": "粗",
    "settings.uiShadow": "阴影",
    "settings.uiShadow.theme": "跟随主题",
    "settings.uiShadow.none": "无",
    "settings.uiShadow.soft": "轻",
    "settings.uiShadow.strong": "强",
    ...
    "settings.ai.modelDeepseekChat": "deepseek-chat（默认）",
    "settings.ai.modelDeepseekReasoner": "deepseek-reasoner",
    "settings.ai.modelRequired": "请先选择模型",
    "settings.ai.modelMissingFallback":
      "AI 已开启但未选择模型，本次将按普通模式创建任务",
    ...
    "settings.ai.placeholderTitle": "占位符列表",
    "settings.ai.placeholder.now": "当前时间",
    "settings.ai.placeholder.userInput": "用户输入原文",
    "settings.ai.placeholder.currentProject": "当前打开项目 ID",
    "settings.ai.placeholder.projectList": "项目列表（JSON）",
    "settings.ai.placeholder.openTasks": "未完成任务（节选/截断）",
    "settings.ai.placeholder.selectedReminder": "已选提醒（JSON）",
    "settings.ai.placeholder.selectedRepeat": "已选重复（JSON）",
    "settings.ai.placeholder.workEndTime": "默认下班时间",
    "settings.ai.placeholder.legacyNow": "旧版：当前时间块",
    "settings.ai.placeholder.legacyUserInput": "旧版：用户输入原文",
    "settings.ai.placeholder.legacySelectedFields": "旧版：已选字段详情",
    "settings.ai.placeholder.legacyOutputSchema": "旧版：输出 JSON 结构",
    ...
    "settings.backup.importPlaceholder": "选择备份文件",
    "settings.backup.importAction": "导入恢复",
    "settings.backup.importHintEmpty": "请选择备份文件",
  ...
  en: {
    ...
    "forced.action.snoozeMore": "More options",
    "forced.action.snoozeLess": "Collapse",
    ...
    "settings.about.button": "View",
    "settings.about.description":
      "Developer: TioitWang\nThis app is built entirely by OpenAI Codex",
    ...
    "settings.theme.elegant": "Elegant (White/Light blue)",
    "settings.theme.web90s": "90s Web",
    "settings.theme.tech": "Tech",
    "settings.theme.calm": "Calm",
    "settings.theme.cyberpunk": "Cyberpunk",
    "settings.uiRadius": "Corners",
    "settings.uiRadius.theme": "Theme default",
    "settings.uiRadius.sharp": "Sharp",
    "settings.uiRadius.round": "Round",
    "settings.uiBorder": "Borders",
    "settings.uiBorder.theme": "Theme default",
    "settings.uiBorder.thin": "Thin",
    "settings.uiBorder.thick": "Thick",
    "settings.uiShadow": "Shadows",
    "settings.uiShadow.theme": "Theme default",
    "settings.uiShadow.none": "None",
    "settings.uiShadow.soft": "Soft",
    "settings.uiShadow.strong": "Strong",
    ...
    "settings.ai.modelDeepseekChat": "deepseek-chat (default)",
    "settings.ai.modelDeepseekReasoner": "deepseek-reasoner",
    "settings.ai.modelRequired": "Please select a model first",
    "settings.ai.modelMissingFallback":
      "AI is enabled but the model is missing. Falling back to normal task creation.",
    "settings.ai.keyMissingFallback":
    ...
    "settings.ai.placeholderTitle": "Placeholders",
    "settings.ai.placeholder.now": "Current time",
    "settings.ai.placeholder.userInput": "User input text",
    "settings.ai.placeholder.currentProject": "Current project ID",
    "settings.ai.placeholder.projectList": "Project list (JSON)",
    "settings.ai.placeholder.openTasks": "Open tasks (truncated)",
    "settings.ai.placeholder.selectedReminder": "Selected reminder (JSON)",
    "settings.ai.placeholder.selectedRepeat": "Selected repeat (JSON)",
    "settings.ai.placeholder.workEndTime": "Default work end time",
    "settings.ai.placeholder.legacyNow": "Legacy: current time block",
    "settings.ai.placeholder.legacyUserInput": "Legacy: user input text",
    "settings.ai.placeholder.legacySelectedFields": "Legacy: selected fields",
    "settings.ai.placeholder.legacyOutputSchema": "Legacy: output JSON schema",
    "settings.ai.placeholderMissingWarn":
    ...
    "settings.backup.importPlaceholder": "Choose a backup file",
    "settings.backup.importAction": "Import & restore",
    "settings.backup.importHintEmpty": "Choose a backup file",
